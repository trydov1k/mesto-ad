...
const checkInputValidity = (formElement, inputElement) => {};  /* проверяет валидность конкретного поля. 
...
const toggleButtonState = (inputList, inputElement) => {};  /* включает или отключает кнопку формы в зависимости от валидности всех полей. 
